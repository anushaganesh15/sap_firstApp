		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "btpapp",
									"targetURL": "#firstapplctn-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"firstapplctn-display": {
								"semanticObject": "firstapplctn",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=firstapplctn",
									"url": sap.ui.require.toUrl("firstapplctn")
								}
							}
						}
					}
